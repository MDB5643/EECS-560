 ...
 * 2) Bulid a leftist heap and skew heap as a Priority Queue
...
int main(int argc, char** argv){
  ...
  if(argc < 2){
    ...
    inputData.open("test/data.txt", ifstream::in);
  } else {
  ...
  cout << endl << "Time Stamp: T" << appCount << endl;
  cout << "Tasks executed: ";
